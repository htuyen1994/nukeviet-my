...
function nv4_block_headertop( $block_config )
{
	...
	$xtpl = new XTemplate( 'global.headertop.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks' );
...
{
	$content = nv4_block_headertop( $block_config );
}

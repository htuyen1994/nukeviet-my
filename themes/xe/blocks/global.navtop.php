...
function nv4_block_navtop( $block_config )
{
	...
	$xtpl = new XTemplate( 'global.navtop.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks' );
...
{
	$content = nv4_block_navtop( $block_config );
}

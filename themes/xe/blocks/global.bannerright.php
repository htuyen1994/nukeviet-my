...
function nv4_block_bannerright( $block_config )
{
	...
	$xtpl = new XTemplate( 'global.bannerright.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks' );
...
{
	$content = nv4_block_bannerright( $block_config );
}

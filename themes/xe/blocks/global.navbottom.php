...
function nv4_block_navbottom( $block_config )
{
	...
	$xtpl = new XTemplate( 'global.navbottom.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks' );
...
{
	$content = nv4_block_navbottom( $block_config );
}

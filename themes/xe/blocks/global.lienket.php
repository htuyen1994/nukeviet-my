...
function nv4_block_lienket( $block_config )
{
	...
	$xtpl = new XTemplate( 'global.lienket.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks' );
...
{
	$content = nv4_block_lienket( $block_config );
}

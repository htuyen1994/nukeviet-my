...
function nv4_block_quangcao( $block_config )
{
	...
	$xtpl = new XTemplate( 'global.quangcao.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks' );
...
{
	$content = nv4_block_quangcao( $block_config );
}

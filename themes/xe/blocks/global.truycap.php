...
function nv4_block_truycap( $block_config )
{
	...
	$xtpl = new XTemplate( 'global.truycap.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks' );
...
{
	$content = nv4_block_truycap( $block_config );
}

...
function nv4_block_footercontent( $block_config )
{
	...
	$xtpl = new XTemplate( 'global.footercontent.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks' );
...
{
	$content = nv4_block_footercontent( $block_config );
}

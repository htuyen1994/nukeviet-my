...
function nv4_block_navfooter( $block_config )
{
	...
	$xtpl = new XTemplate( 'global.navfooter.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks' );
...
{
	$content = nv4_block_navfooter( $block_config );
}

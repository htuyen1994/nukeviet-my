...
function nv4_block_silde( $block_config )
{
	...
	$xtpl = new XTemplate( 'global.silde.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks' );
...
{
	$content = nv4_block_silde( $block_config );
}

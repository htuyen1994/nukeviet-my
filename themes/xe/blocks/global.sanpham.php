...
function nv4_block_sanpham( $block_config )
{
	...
	$xtpl = new XTemplate( 'global.sanpham.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks' );
...
{
	$content = nv4_block_sanpham( $block_config );
}

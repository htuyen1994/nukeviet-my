...
function nv4_block_tienich( $block_config )
{
	...
	$xtpl = new XTemplate( 'global.tienich.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks' );
...
{
	$content = nv4_block_tienich( $block_config );
}

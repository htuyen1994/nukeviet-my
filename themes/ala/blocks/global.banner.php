...
function nv4_block_banner( $block_config )
{
	...
	$xtpl = new XTemplate( 'global.banner.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks' );
...
{
	$content = nv4_block_banner( $block_config );
}

...
function nv4_block_thongtin( $block_config )
{
	...
	$xtpl = new XTemplate( 'global.thongtin.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks' );
...
{
	$content = nv4_block_thongtin( $block_config );
}

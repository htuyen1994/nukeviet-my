...
function nv4_block_menutop( $block_config )
{
	...
	$xtpl = new XTemplate( 'global.menutop.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks' );
...
{
	$content = nv4_block_menutop( $block_config );
}

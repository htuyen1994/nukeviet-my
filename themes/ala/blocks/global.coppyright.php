...
function nv4_block_coppyright( $block_config )
{
	...
	$xtpl = new XTemplate( 'global.coppyright.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks' );
...
{
	$content = nv4_block_coppyright( $block_config );
}
